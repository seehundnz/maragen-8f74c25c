...
- 🌍 **UI in 10 languages** (English, German, Spanish, French, Italian, Dutch, Swedish, Norwegian, Croatian, Czech — plus automatic device-language detection) — radio scripts intentionally stay in English, the international language of VHF maritime communication
